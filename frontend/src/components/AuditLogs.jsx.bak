...
function AuditLogs({ onClose }) {
  ...
  function getActionColor(action) {
    switch (action) {
      case 'create': return C.green5
      case 'update': return C.blue5
      case 'delete': return C.red5
      case 'login': return C.purple5
      default: return C.gray4
    }
  }
